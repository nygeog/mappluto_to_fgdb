...
#theMergeFileUse = r'C:\GIS\MapPluto\MapPluto.gdb\mappluto_13v1\testNEW21'
for lvar in lvars:
    print "Merging all boros for MapPluto_" + lvar
    workspaceUse = 'C:/GIS\MapPluto/downloads/'+lvar
    theMergeFileUse = 'C:/GIS/MapPluto/MapPluto.gdb/mappluto_'+lvar+'/mappluto_'+lvar
    recursive_list_fcs(workspaceUse, theMergeFileUse, wild_card=None, feature_type=None)

print "All right, all done. Let me know of any errors, etc."